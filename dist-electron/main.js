...
var MS = "\0☺☻♥♦♣♠•◘○◙♂♀♪♫☼►◄↕‼¶§▬↨↑↓→←∟↔▲▼ !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~⌂ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜ¢£¥₧ƒáíóúñÑªº¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ";
function Va(e, t, n, r) {
  if (r)
  ...
  constructor(t) {
    ...
    xe(this, "downloadFile", async (t, n) => {
      ...
      try {
        ...
        return await r.close(), this.sendLog(` 😈 下载失败:${i.message}，特种兵半路被击毙...`, "error"), ae.unlinkSync(n), !1;
      }
    });
    // 解压文件
    xe(this, "unzipFile", async (t, n) => {
      ...
      try {
        ...
        return this.sendLog(`🤩 空投里面居然有${i},大吉大利今晚肯定吃鸡 🐔`), ae.unlinkSync(t), !0;
      } catch (r) {
        return this.sendLog(`舔包失败，被老六蹲了: ${r.message}`, "error"), ae.unlinkSync(t), !1;
      }
    });
    // 获取默认开发者工具路径
    ...
    xe(this, "writeConfig", (t) => {
      ae.writeFileSync(this.configPath, JSON.stringify(t, null, 4), "utf8"), this.sendLog("配置文件已更新"), this.reportConfig();
    });
    // 启动支付宝
